...
var GlobalState = function GlobalState(_ref) {
  ...
  var getProductsPaginated = function getProductsPaginated(pageSize) {
    ...
    while (pageNumber <= productState.products.length / pageSize) {
      productsPaginated.push(productState.products.slice(pageNumber * pageSize, (pageNumber + 1) * pageSize));
      pageNumber++;
    }

    return productsPaginated; // return productState.products.reduce((acc, x) => {
...
//# sourceMappingURL=_app.js.6e0339cacccb282f70a2.hot-update.js.map