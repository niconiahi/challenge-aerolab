...
var GlobalState = function GlobalState(_ref) {
  ...
  var getProductsPaginated = function getProductsPaginated(pageSize) {
    ...
    while (pageNumber <= productState.products.length / pageSize) {
      productsPaginated[pageNumber].push(productState.products.slice(pageNumber * pageSize, (pageNumber + 1) * pageSize));
      pageNumber++;
...
//# sourceMappingURL=_app.js.70f6a85442c5878fb102.hot-update.js.map